...
<?php
    ...
    require_once($_SERVER['DOCUMENT_ROOT'].'/ProjectPHP/layout/user/method/getTag.php');
    require_once($_SERVER['DOCUMENT_ROOT'].'/ProjectPHP/class/ProductTag.Class.php');
    require_once($_SERVER['DOCUMENT_ROOT'].'/ProjectPHP/class/Product.Class.php');
    require_once($_SERVER['DOCUMENT_ROOT'].'/ProjectPHP/layout/admin/quan-ly-san-pham/getTagWithIDProduct.php');
    $tag = getTag();
 ...
 ?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    function check(){
      ...
      var url = 'http://localhost/ProjectPHP/layout/admin/quan-ly-san-pham/tagData.php';
      var showTag;
       //document.write(f);
