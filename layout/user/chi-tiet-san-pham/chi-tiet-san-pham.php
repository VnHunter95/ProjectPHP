...
<!--demo-->
<?php
include($_SERVER['DOCUMENT_ROOT']."/layout/user/method/getProductDetail.php");

if(!isset($_GET["productid"])){
	header('Location: not_found.php'); // Page ảo
}
else
{
	$id = $_GET["productid"];
		...
		<div class="product">
			<div class="container">
				<div class="col-md-3 product-price">
						<?php include($_SERVER['DOCUMENT_ROOT']."/layout/user/chi-tiet-san-pham/displayCategoryLeftside.php"); ?>
						<!--initiate accordion-->
						...
						<!---->
							<?php include($_SERVER['DOCUMENT_ROOT']."/layout/user/chi-tiet-san-pham/displayTagLeftSide.php"); ?>
						<!---->
				</div>
...
<script src="js/goToProductList.js"></script>
</body>
</html>
