<?php require_once($_SERVER['DOCUMENT_ROOT']."/ProjectPHP/class/ProductGroup.Class.php");
			...
			require_once($_SERVER['DOCUMENT_ROOT']."/ProjectPHP/class/Helper.php");
?>
<!DOCTYPE html>
<html>
<head>
      ...
      <nav class="navbar navbar-inverse">
          <div class="container-fluid">
              <div class="navbar-header">
                  <div class="logo">
                      <a href="<?php echo 'http://'.$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']; ?>"><img src="/shared/image/logo.png" alt="" style="height: 50px ; width: 50px;"></a>
                  </div>
              </div>
